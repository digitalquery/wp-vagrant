...
apt-get install -qy nginx php5 php5-fpm php5-gd php5-mysql php5-cgi php5-cli php5-curl ffmpeg vim git-core mysql-server-5.5 mysql-client curl php5-xdebug tmux
